  ...
  return (
    <div className="min-h-screen bg-[var(--brand-surface)]">
      ...
      <main className="px-4 -mt-8">
        {/* Main Card */}
        <div className="bg-[var(--brand-surface)] rounded-2xl shadow-lg p-6 mb-4">
          <h2 className="text-lg font-bold text-[var(--brand-text)] mb-3">🎯 {t('title')}</h2>
          <p className="text-[var(--brand-text-secondary)] text-sm leading-relaxed mb-4">
            {t('description')}
          </p>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium text-[var(--brand-text)] text-sm">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--brand-text-secondary)] text-xs">
                  {t('features.billScanning.description')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--brand-text-secondary)] text-xs">
                  {t('features.roiCalculation.description')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--brand-text-secondary)] text-xs">
                  {t('features.pdfQuote.description')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[var(--brand-text-secondary)] text-xs">
                  {t('features.carbonFootprint.description')}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 mb-4">
          <h2 className="text-lg font-bold text-[var(--brand-text)] mb-4 text-center">
            📊 {t('stats.title')}
          </h2>
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              ...
              <div className="text-xs text-[var(--brand-text-secondary)]">
                {t('stats.installations')}
              </div>
            </div>
            <div>
              <div className="text-2xl font-bold text-yellow-600">15M+</div>
              <div className="text-xs text-[var(--brand-text-secondary)]">{t('stats.savings')}</div>
            </div>
          </div>
        </div>
        ...
        {/* Contact Card */}
        <div className="bg-[var(--brand-surface)] rounded-2xl shadow-lg p-6 mb-4">
          <h2 className="text-lg font-bold text-[var(--brand-text)] mb-3">
            📞 {t('contact.title')}
          </h2>
          <div className="space-y-3">
            <button
              onClick={handleContactUs}
              className="w-full flex items-center gap-3 p-3 bg-[var(--brand-background)] rounded-xl hover:bg-[var(--brand-background)] transition-colors"
            >
              <div className="w-10 h-10 rounded-full bg-green-500/10 flex items-center justify-center">
                <span className="text-green-600">📱</span>
              </div>
              <div className="text-left">
                <div className="font-medium text-[var(--brand-text)] text-sm">
                  {t('contact.call')}
                </div>
                <div className="text-[var(--brand-text-secondary)] text-xs">02-000-0000</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-[var(--brand-text-secondary)] text-xs">solariq.app</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-[var(--brand-text-secondary)] text-xs">
                  contact@solariq.app
                </div>
              </div>
            </a>
        ...
        {/* Version */}
        <div className="text-center text-[var(--brand-text-secondary)] text-xs mb-4">
          <p>{t('version')}</p>
          <p>{t('copyright')}</p>
        </div>
        ...
        {isInLINE && (
          <button
            onClick={handleClose}
            className="w-full py-3 bg-[var(--brand-background)] text-[var(--brand-text-secondary)] rounded-xl font-medium mb-4"
          >
            {t('close')}
          </button>
        )}
      ...
      {/* User info */}
      {user && (
        <div className="fixed top-4 right-4 bg-[var(--brand-surface)]/90 backdrop-blur-sm rounded-full px-3 py-1 shadow text-xs text-[var(--brand-text-secondary)]">
          {user.displayName}
        </div>
      )}
    </div>
