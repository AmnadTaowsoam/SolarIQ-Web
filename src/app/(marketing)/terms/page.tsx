        ...
        <div className="lg:grid lg:grid-cols-4 lg:gap-12">
          ...
          <div className="lg:col-span-3 prose prose-gray dark:prose-invert max-w-none">
            ...
            <section id="payment" className="scroll-mt-24 mb-10">
              ...
              <ul className="list-disc pl-6 space-y-2 text-[var(--brand-text-secondary)] dark:text-[var(--brand-text-secondary)]">
                <li>
                  <strong>การทดลองใช้ฟรี:</strong> ผู้ใช้ใหม่ได้รับสิทธิ์ทดลองใช้งานฟรี 14 วัน
                  โดยไม่ต้องใช้บัตรเครดิต ระหว่างช่วงทดลองใช้จะไม่มีการเรียกเก็บเงินใดๆ
                </li>
                <li>
                  <strong>การเริ่มเรียกเก็บเงิน:</strong> หลังจากครบ 14 วัน ระบบจะ
                  <strong>ไม่</strong>เรียกเก็บเงินอัตโนมัติ
                  ผู้ใช้ต้องเลือกแพ็กเกจและชำระเงินด้วยตนเองเท่านั้น
                </li>
                <li>
                  <strong>แพ็กเกจฟรีหลังทดลองใช้:</strong> หากผู้ใช้ไม่เลือกแพ็กเกจหลังจากทดลองใช้
                  จะได้รับฟรี 5 leads/เดือนต่อไป
                </li>
                <li>
                  <strong>ค่าบริการ:</strong> ค่าบริการจะเรียกเก็บตามแพ็กเกจที่เลือก
                  (รายเดือนหรือรายปี) ราคาแสดงเป็นสกุลเงินบาทไทย (THB) และยังไม่รวมภาษีมูลค่าเพิ่ม
                  7%
                </li>
                <li>
                  <strong>การต่ออายุอัตโนมัติ:</strong>{' '}
                  แพ็กเกจรายเดือนและรายปีจะต่ออายุอัตโนมัติตามรอบบิล
                  ผู้ใช้สามารถยกเลิกได้ตลอดเวลาจากหน้า Billing ในแพลตฟอร์ม
                </li>
                <li>
                  <strong>ช่องทางชำระเงิน:</strong> รองรับการชำระผ่านบัตรเครดิต/เดบิต (Visa,
                  Mastercard, JCB), พร้อมเพย์ (PromptPay), และโอนผ่านธนาคาร (SCB, KBANK, BBL)
                  ผ่านระบบ Opn Payments ที่ปลอดภัย
                </li>
                <li>
                  <strong>การเปลี่ยนแปลงราคา:</strong>{' '}
                  บริษัทขอสงวนสิทธิ์ในการเปลี่ยนแปลงราคาโดยจะแจ้งให้ทราบล่วงหน้าอย่างน้อย 30 วัน
                </li>
                <li>
                  <strong>การชำระเงินล้มเหลว:</strong> หากการชำระเงินล้มเหลว
                  บริษัทจะพยายามเรียกเก็บซ้ำภายใน 3 วันทำการ
                </li>
                <li>
                  <strong>ใบกำกับภาษี (VAT Invoice):</strong>{' '}
                  ผู้ใช้สามารถขอรับใบกำกับภาษีได้โดยไปที่หน้า Billing &gt; Invoices และคลิกปุ่ม
                  &quot;ขอใบกำกับภาษี&quot; ระบบจะส่งใบกำกับภาษีให้ภายใน 3-7 วันทำการ
                </li>
              </ul>
            </section>
