    ...
    <div>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-gray dark:prose-invert max-w-none">
          {/* Introduction */}
          <div className="rounded-xl border border-blue-200 dark:border-blue-800 bg-blue-500/10 dark:bg-blue-900/20 p-6 mb-10 not-prose">
          ...
          <section className="mb-10">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="w-full border-collapse border border-[var(--brand-border)] dark:border-gray-700 text-sm">
                <thead>
                  <tr className="bg-[var(--brand-background)] dark:bg-gray-800">
                    <th className="border border-[var(--brand-border)] dark:border-gray-700 px-4 py-3 text-left font-semibold text-[var(--brand-text)] dark:text-white">
                      กรณี
                    </th>
                    <th className="border border-[var(--brand-border)] dark:border-gray-700 px-4 py-3 text-left font-semibold text-[var(--brand-text)] dark:text-white">
                      การคืนเงิน
                ...
                <tbody>
                  <tr>
                    <td className="border border-[var(--brand-border)] dark:border-gray-700 px-4 py-3 text-[var(--brand-text-secondary)] dark:text-[var(--brand-text-secondary)]">
                  ...
                  <tr className="bg-[var(--brand-background)]/50 dark:bg-gray-800/50">
                    <td className="border border-[var(--brand-border)] dark:border-gray-700 px-4 py-3 text-[var(--brand-text-secondary)] dark:text-[var(--brand-text-secondary)]">
          ...
          <section className="mb-10">
            ...
            <div className="rounded-xl border border-[var(--brand-border)] dark:border-gray-700 bg-[var(--brand-background)] dark:bg-gray-800 p-6 not-prose mb-4">
              <p className="text-sm text-[var(--brand-text-secondary)] dark:text-[var(--brand-text-secondary)] mb-2">
                สูตรการคำนวณ:
              </p>
              <p className="text-lg font-mono font-semibold text-[var(--brand-text)] dark:text-white">
            ...
            <div className="rounded-xl border border-[var(--brand-border)] dark:border-gray-700 bg-[var(--brand-background)] dark:bg-gray-800 p-6 not-prose">
              <div className="space-y-2 text-sm text-[var(--brand-text-secondary)] dark:text-[var(--brand-text-secondary)]">
                <p>ค่าบริการรายเดือนปกติ: ฿3,990/เดือน</p>
                <p>ใช้ไป 1 เดือน: ฿3,990 x 1 = ฿3,990</p>
                <p className="font-semibold text-green-600 dark:text-green-400 text-base pt-2 border-t border-[var(--brand-border)] dark:border-gray-700">
          ...
          <section className="mb-10">
            ...
            <p className="text-[var(--brand-text-secondary)] dark:text-[var(--brand-text-secondary)] leading-relaxed mt-3 text-sm">
