...
const faqs = [
  ...
  {
    q: 'ยกเลิกได้ตลอดเวลาหรือไม่?',
    a: 'ได้ คุณสามารถยกเลิกแพ็กเกจได้ตลอดเวลาโดยไม่มีค่าใช้จ่ายเพิ่มเติม เมื่อยกเลิกแล้วคุณจะยังสามารถใช้งานได้จนถึงสิ้นรอบบิลปัจจุบัน',
  },
  {
    q: 'รองรับการชำระเงินแบบไหนบ้าง?',
    a: 'เรารองรับบัตรเครดิต/เดบิต (Visa, Mastercard, JCB), โอนผ่านธนาคาร, พร้อมเพย์ และ QR Payment สำหรับแพ็กเกจ Enterprise สามารถออกใบแจ้งหนี้และชำระแบบรายปีได้',
  },
  {
