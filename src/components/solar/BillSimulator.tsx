...
export function BillSimulator({
  ...
  const monthlyData = useMemo(() => {
    return THAI_MONTHS_SHORT.map((name, idx) => {
      const factor = SEASONAL_FACTOR[idx] ?? 1
  ...
  return (
    <Card>
      <CardHeader
        title={
          '\u0E40\u0E1B\u0E23\u0E35\u0E22\u0E1A\u0E40\u0E17\u0E35\u0E22\u0E1A\u0E04\u0E48\u0E32\u0E44\u0E1F\u0E01\u0E48\u0E2D\u0E19-\u0E2B\u0E25\u0E31\u0E07\u0E15\u0E34\u0E14\u0E42\u0E0B\u0E25\u0E32\u0E23\u0E4C'
        }
              ...
              <div className="space-y-1.5 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[var(--brand-text)]">
                    {formatCurrency(beforeUnits * electricityRate)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[var(--brand-text-secondary)]">
            ...
            <div className="p-4 rounded-xl border-2 border-green-500/20 bg-green-500/5">
              ...
              <div className="space-y-1.5 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[var(--brand-text)]">
                    {formatCurrency(afterUnits * electricityRate)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-[var(--brand-text-secondary)]">
