      ...
      <CardBody>
        <div className="space-y-6">
          ...
          <div className="flex flex-col items-center">
            ...
            {/* Level Badge */}
            <div
              className={`mt-3 px-4 py-2 rounded-full ${levelConfig.bg} flex items-center gap-2`}
            >
            ...
            <div>
              ...
              <div className="space-y-2">
                {data.tips.map((tip, idx) => (
                  <div
                    key={idx}
                    className="flex items-start gap-2 p-2 rounded-lg bg-[var(--brand-surface)] border border-[var(--brand-border)]"
                  >
