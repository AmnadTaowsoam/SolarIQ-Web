...
export function FinancingCalculator({ systemCost, annualSavings }: FinancingCalculatorProps) {
  ...
  const options = useMemo(() => {
    ...
    const loanMonthly =
      monthlyRate > 0
        ? (systemCost * monthlyRate * Math.pow(1 + monthlyRate, nPayments)) /
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-[var(--brand-text)]">
                      {formatCurrency(opt.upfrontCost)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-[var(--brand-text-secondary)]">
                  ...
                  <div className="flex justify-between pt-2 border-t border-[var(--brand-border)]">
                    ...
                    <span
                      className={`font-bold ${opt.netSavings > 0 ? 'text-green-600' : 'text-red-600'}`}
                    >
          ...
          <div className="p-3 rounded-lg bg-blue-500/5 border border-blue-500/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs text-[var(--brand-text-secondary)]">
              <div className="p-2 rounded bg-[var(--brand-surface)]">
                <span className="font-bold text-purple-600">SCB</span> -{' '}
                {
                  '\u0E2A\u0E34\u0E19\u0E40\u0E0A\u0E37\u0E48\u0E2D\u0E42\u0E0B\u0E25\u0E32\u0E23\u0E4C\u0E40\u0E0B\u0E25\u0E25\u0E4C'
                }
              </div>
              <div className="p-2 rounded bg-[var(--brand-surface)]">
                <span className="font-bold text-green-600">KBANK</span> -{' '}
                {
                  '\u0E2A\u0E34\u0E19\u0E40\u0E0A\u0E37\u0E48\u0E2D\u0E1E\u0E25\u0E31\u0E07\u0E07\u0E32\u0E19\u0E2A\u0E30\u0E2D\u0E32\u0E14'
                }
              </div>
              <div className="p-2 rounded bg-[var(--brand-surface)]">
                <span className="font-bold text-blue-600">BBL</span> -{' '}
                {'\u0E2A\u0E34\u0E19\u0E40\u0E0A\u0E37\u0E48\u0E2D Green Energy'}
              </div>
            </div>
          </div>
        </div>
