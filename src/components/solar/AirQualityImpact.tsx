...
function getAqiConfig(aqi: number) {
  if (aqi <= 50)
    return { label: '\u0E14\u0E35', color: 'text-green-600', bg: 'bg-green-500', bgLight: 'bg-green-500/10', border: 'border-green-500/20' }
  if (aqi <= 100)
    return { label: '\u0E1B\u0E32\u0E19\u0E01\u0E25\u0E32\u0E07', color: 'text-yellow-600', bg: 'bg-yellow-500', bgLight: 'bg-yellow-500/10', border: 'border-yellow-500/20' }
  if (aqi <= 150)
    return { label: '\u0E44\u0E21\u0E48\u0E14\u0E35\u0E15\u0E48\u0E2D\u0E01\u0E25\u0E38\u0E48\u0E21\u0E40\u0E2A\u0E35\u0E48\u0E22\u0E07', color: 'text-orange-600', bg: 'bg-orange-500', bgLight: 'bg-orange-500/10', border: 'border-orange-500/20' }
  if (aqi <= 200)
    return { label: '\u0E44\u0E21\u0E48\u0E14\u0E35\u0E15\u0E48\u0E2D\u0E2A\u0E38\u0E02\u0E20\u0E32\u0E1E', color: 'text-red-600', bg: 'bg-red-500', bgLight: 'bg-red-500/10', border: 'border-red-500/20' }
  return { label: '\u0E2D\u0E31\u0E19\u0E15\u0E23\u0E32\u0E22\u0E21\u0E32\u0E01', color: 'text-purple-600', bg: 'bg-purple-500', bgLight: 'bg-purple-500/10', border: 'border-purple-500/20' }
}

const DUST_MONTHS = [
  { month: 1, name: '\u0E21.\u0E04.' }, { month: 2, name: '\u0E01.\u0E1E.' },
  { month: 3, name: '\u0E21\u0E35.\u0E04.' }, { month: 4, name: '\u0E40\u0E21.\u0E22.' },
  { month: 5, name: '\u0E1E.\u0E04.' }, { month: 6, name: '\u0E21\u0E34.\u0E22.' },
  { month: 7, name: '\u0E01.\u0E04.' }, { month: 8, name: '\u0E2A.\u0E04.' },
  { month: 9, name: '\u0E01.\u0E22.' }, { month: 10, name: '\u0E15.\u0E04.' },
  { month: 11, name: '\u0E1E.\u0E22.' }, { month: 12, name: '\u0E18.\u0E04.' },
]

export function AirQualityImpact({ airQuality, dustSeason }: AirQualityImpactProps) {
  const dustMonthSet = useMemo(() => {
    if (!dustSeason?.worstMonths) return new Set<string>()
      ...
      <CardBody>
        <div className="space-y-5">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            {/* AQI Circle */}
            <div className={`relative w-28 h-28 rounded-full ${aqiConfig.bgLight} border-4 ${aqiConfig.border} flex flex-col items-center justify-center`}>
            ...
            <div className="flex-1 space-y-3">
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span className="text-[var(--brand-text-secondary)]">PM2.5: {airQuality.pm25} \u00B5g/m\u00B3</span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="p-2 rounded-lg bg-red-500/5 border border-red-500/10">
                  ...
                  <div className="text-lg font-bold text-red-600">
                    -{airQuality.solarEfficiencyLoss.toFixed(1)}%
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="p-3 rounded-lg bg-orange-500/5 border border-orange-500/20 text-center">
                ...
                <div className="text-2xl font-bold text-orange-600">
                  {(100 - airQuality.solarEfficiencyLoss).toFixed(1)}%
                </div>
              </div>
            </div>
          </div>
          ...
          {dustSeason && (
            <div>
              ...
              <div className="flex items-center gap-3 text-xs text-[var(--brand-text-secondary)]">
                ...
                <span>
                  {'\u0E01\u0E32\u0E23\u0E2A\u0E39\u0E0D\u0E40\u0E2A\u0E35\u0E22\u0E1B\u0E23\u0E30\u0E08\u0E33\u0E1B\u0E35'}: -{formatNumber(dustSeason.annualLossPercent)}%
                </span>
              </div>
            </div>
          )}
