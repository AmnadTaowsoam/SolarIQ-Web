...
const pageTitles: Record<string, { title: string; description?: string }> = {
  '/dashboard': { title: 'Dashboard', description: 'Overview of your solar business' },
  '/leads': { title: 'Lead Management', description: 'Track and manage your leads' },
  '/analyze': { title: 'Solar Analysis', description: 'Analyze solar potential for any location' },
  '/knowledge': { title: 'Knowledge Base', description: 'Manage documents and data sources' },
  '/pricing': { title: 'Pricing Management', description: 'Configure installation costs and rates' },
  '/billing': { title: 'Billing & Subscription', description: 'Manage your plan and invoices' },
  '/privacy': { title: 'Privacy Settings', description: 'Manage consent and data privacy' },
  '/settings': { title: 'ตั้งค่า', description: 'จัดการข้อมูลบริษัท การเชื่อมต่อ และสิทธิ์การใช้งาน' },
}
      ...
      <div className="flex items-center justify-between h-14 px-4 lg:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden lg:block">
            <h1 className="text-sm font-semibold text-gray-900">{pageInfo.title}</h1>
            {pageInfo.description && (
              <p className="text-[11px] text-gray-400">{pageInfo.description}</p>
            )}
          </div>
        </div>
