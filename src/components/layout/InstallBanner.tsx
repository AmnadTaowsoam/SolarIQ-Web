  ...
  return (
    <div
      className={clsx(
        ...
        isAnimating ? (
          isMobile ? 'translate-y-0 opacity-100' : 'translate-y-0 opacity-100'
        ) : (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p
            className={clsx(
              'text-xs truncate',
              isMobile ? 'text-slate-400' : 'text-white/80'
            )
          >
            {isMobile ? 'Add to home screen for quick access' : 'Install for faster access and offline support'}
          </p>
        </div>
