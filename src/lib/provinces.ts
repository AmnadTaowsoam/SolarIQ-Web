...
export const THAI_PROVINCES: ProvinceOption[] = [
  { th: 'กระบี่', en: 'Krabi' },
...
export function getProvinceLabel(province: ProvinceOption, locale: Locale): string {
  return locale === 'en' ? province.en : province.th
}
